...
import FALLBACK from '../../data/aboutContent'
...
function ServiceCard({ service, phone, email, hours }) {
  return (
    <div className="service-card">
      <div className="service-card__name">{service}</div>
...
export default function About() {
  ...
  useEffect(() => {
    fetch(`${API}/api/school-profile`)
      .then(r => r.ok ? r.json() : null)
      .then(json => { if (json && json.schoolName) setData(json) })
      .catch(() => {})
  }, [])
  ...
  const houses          = data.houses          || FALLBACK.houses
  const anthem          = data.anthem          || FALLBACK.anthem
  const faqs            = data.faqs            || FALLBACK.faqs
  const serviceContacts = data.serviceContacts || FALLBACK.serviceContacts
      ...
      <div className="about-page" ref={pageRef}>
        ...
        >
          ...
          <div className="about-banner__overlay">
            <h1 className="about-banner__title">{data.schoolName}</h1>
        ...
        <section className="about-hero">
          ...
          <div className="about-hero__text">
            <h1 className="about-hero__name">{data.schoolName}</h1>
            <p className="about-hero__tagline">Excellence · Character · Service</p>
            <p className="about-hero__description">
              Founded in {data.founded}, {data.schoolName} is one of Ghana's most prestigious secondary schools,
        ...
        <section className="about-info-strip">
          <div className="about-info-item">
            ...
            <span className="about-info-item__value">{data.founded}</span>
          </div>
          <div className="about-info-divider" />
          <div className="about-info-item">
            <span className="about-info-item__label">Location</span>
            <span className="about-info-item__value">{data.location}</span>
          </div>
          <div className="about-info-divider" />
          <div className="about-info-item">
            <span className="about-info-item__label">Houses</span>
            <span className="about-info-item__value">{houses.length} Houses</span>
          </div>
          <div className="about-info-divider" />
          <div className="about-info-item">
            ...
            <div className="about-card">
              ...
              >
                <span className="about-card__toggle-label">
                  ...
                  Houses <span className="about-card__toggle-badge">{houses.length}</span>
                </span>
            ...
            <div className="about-card">
              ...
              <div className="about-profile-grid">
                <div className="about-profile-row">
                  ...
                  <span className="about-profile-value">{data.schoolName}</span>
                </div>
                <div className="about-profile-row">
                  <span className="about-profile-label">Type</span>
                  <span className="about-profile-value">{data.type || 'Public Boarding / Day'}</span>
                </div>
                <div className="about-profile-row">
                  <span className="about-profile-label">Motto</span>
                  <span className="about-profile-value">{data.motto}</span>
                </div>
                <div className="about-profile-row">
                  <span className="about-profile-label">Headmaster</span>
                  <span className="about-profile-value">{data.headmaster}</span>
                </div>
                <div className="about-profile-row">
                  <span className="about-profile-label">P.O. Box</span>
                  <span className="about-profile-value">{data.poBox}</span>
                </div>
                <div className="about-profile-row">
                  <span className="about-profile-label">Website</span>
                  <span className="about-profile-value">{data.website}</span>
                </div>
              </div>
            </div>
